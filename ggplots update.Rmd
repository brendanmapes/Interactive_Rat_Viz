...
plot1 <- ggplot() + geom_bar(data=rat_borough, aes(x=Borough, y=count, fill=Borough), stat="identity") + ggtitle("2020 rodent reports") + ylab("Number of 311 calls\n") + xlab("\nBorough") + theme_economist() + theme(axis.title.x=element_text(face="bold"), axis.title.y=element_text(face="bold"), legend.position="none") +  theme(axis.text.x = element_text(angle = 40, vjust=.7)) 


plot2 <- ggplot() + geom_bar(data=restaurant_borough, aes(x =Borough, y= count, fill =Borough), stat="identity") + ggtitle("Outdoor restaurants") + ylab("Applications approved\n") + xlab("\nBorough") + theme_economist() + theme(axis.title.x=element_text(face="bold"), legend.position="none", axis.title.y=element_text(face="bold")) + theme(axis.text.x = element_text(angle = 40, vjust=.7))
