...
server <- function(input, output, session) {
  ...
  created_date_sample$dates <- parse_date_time(created_dt$V1, '%m/%d/%y %I:%M:%S %p')
  ...
  output$yearViz <- renderPlotly({
      ggplotly(
        ggplot(data=plot_created_year, aes(x=Var1, y=Freq)) + geom_bar(stat="identity") + xlab("Year") + xlim(2010,2021)
      )
  })
