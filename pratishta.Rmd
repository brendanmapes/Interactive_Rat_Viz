...
```{r}
convertToShpDistrict <- function(borough, number) { 
  boro = ''
  d_num = ''
  boro = case_when (str_to_lower(borough) == 'brooklyn' ~ 'BK',
                    str_to_lower(borough) == 'manhattan' ~ 'MN',
                    str_to_lower(borough) == 'queens' ~ 'QW',
                    str_to_lower(borough) == 'staten island' ~ 'SI',
                    str_to_lower(borough) == 'bronx' ~ 'BX'
                    )
  }
```
